...
const DocumentStatusForm = ({ styles, handleChange, shipment, theme }) => {
  return (
    ...
    <CheckBox
            ...
            onChange={underApproval => handleChange({ ...shipment, underApproval })}>
            {`Under Approval`}
          </CheckBox>
          <CheckBox
            style={styles.input}
            checked={shipment.documentApproved}
            onChange={documentApproved => handleChange({ ...shipment, documentApproved })}>
            {`Documents Approved`}
          </CheckBox>
          <Divider style={styles.divider} />
          <CheckBox
            ...
            onChange={documentIssued => handleChange({ ...shipment, documentIssued })}>
            {`Documents Issued`}
          </CheckBox>
    </>
  );
